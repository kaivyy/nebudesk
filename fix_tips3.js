...
const target = `<h2 className="text-lg font-semibold mb-4 border-b pb-2 flex items-center">
              <Settings size={18} className="mr-2" /> Cloudflare Integration
            </h2>`;

const newHeader = `<div className="flex items-center justify-between mb-4 border-b pb-2">
