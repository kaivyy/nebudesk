...
const target = `2. Access securely via your browser: \`http://100.x.x.x:5050\` *(replace with your VPS Tailscale IP)*.
3. Open **App Manager > Discovery** to start adopting your internal apps!`;

const replacement = `2. Access securely via your browser: \`http://100.x.x.x:5050\` *(replace with your VPS Tailscale IP)*.
